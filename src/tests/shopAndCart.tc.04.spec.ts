...
import * as testData from '../data/shop/tc04-test-data.json';

test.describe('Shop Page Tests', () => {
  test('Test Case 4: Add items to cart, navigate to cart page, and validate amounts', async ({ homePage, shopPage }) => {
